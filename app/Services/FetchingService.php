...
class FetchingService
{
     ...
     *
     * @param string $type (`persons`)
     */
    public function fetchFile(string $type)
    {
        $date = Carbon::now();
     ...
     * @param string $type
     */
    public function extract(string $type)
    {
     ...
     * @param string $job
     */
    public function fetch(string $type, string $job)
    {
     ...
     * @param string $type
     */
    public function deleteFiles(string $type)
    {
